...
[![Last Update](https://img.shields.io/badge/更新日期-2026--09--22-2da44e.svg)](data/anime.manifest.json)
[![Records](https://img.shields.io/badge/记录数-30924-2da44e.svg)](data/anime.manifest.json)
...
```
Bangumi-Archive-Anime-Excel/
├── data/                                # BGM 插件数据源（~21 MB，30924 条，gzip，共 6 片）
...
- **大小**：约 21 MB（22,340,985 字节，解压后 58.03 MiB）
- **记录数**：30924 条
